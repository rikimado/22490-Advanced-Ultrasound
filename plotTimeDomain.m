...
% Plot signals
figure;
plot(t_exc*1e6, excitation, 'k', 'LineWidth', 1.2, 'DisplayName', ['e(t) - ' num2str(N_exc) ' cycle(s)']);
hold on;
plot(t_imp*1e6, impulse_response, 'r--', 'LineWidth', 1.2, 'DisplayName', ['v(t) - ' num2str(N_imp) ' cycle(s)']);
